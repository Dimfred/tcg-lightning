...
<section id="hero">
  ...
  <!-- Screenshot Carousel (full width, below the fold) -->
  <div class="py-16 md:py-24 relative w-full px-4 text-center" use:reveal={200}>
    <div
      class="mx-auto space-y-4"
      style="max-width: min(100%, calc((100vh - 8rem) * 16 / 9));"
    >
      <div
        class="relative aspect-video rounded-xl overflow-hidden border border-border/50 shadow-2xl shadow-black/50 {allFailed
